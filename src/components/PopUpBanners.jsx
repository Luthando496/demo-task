  ...
  return  createPortal(
    ...
    <section className="w-full min-h-screen  bg-white relative">
      ...
      <div className='absolute h-full flex  px-4 w-full justify-center items-center'>
        <article className="px-4 z-10 my-4 md:px-10 py-5 bg-white rounded-2xl xl">
          ...
          <h2 className='text-xl leading-[1.4]  md:text-[30px] font-semibold md:font-bold'>Would you also like to <br />  book  these  services</h2>
            

              <h2 className='text-xl text-center md:text-3xl font-semibold md:font-bold text-green-1 my-2'>
              <TypeAnimation
      sequence={[
        'Flight Tickets',
        900,
      ...
      className='text-xl text-center md:text-3xl font-semibold md:font-bold text-green-1'
    ...
    />
              ...
              <h2 className='text-xl leading-[1.3]  md:text-[30px] font-semibold md:font-bold'>While we automatically create<br className='' />  a <span className="text-green-1">well-rounded-itinerary</span> for you.
            </h2>
