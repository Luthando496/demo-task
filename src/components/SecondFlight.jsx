...
const SecondFlight = () => {
  return (
    ...
    {/* ///card */}
    <div className=" mx-auto  py-8 my-4 ">
    ...
    <div className="w col-span-2 lg:border-r-2 lg:border-r-black">
    ...
    <h2 className="text-sm md:text-xl text-gray-700 font-semibold">Landing At Cape Town International Airport</h2>
